...
// 				if (+d.Year === i) {
// 					d.Year = +d.Year;
// 					d["Share of global CO₂ emissions (%)"] = +d["Share of global CO₂ emissions (%)"];
// 					year.push(d);
// 				}
// 			});
...
// 		const val_extent = d3.max(years[2016], (d) => {
// 			// console.log(d["Share of global CO₂ emissions (%)"]);
// 			return d["Share of global CO₂ emissions (%)"];
// 		});
...
// 			// console.log(d);
// 			if (d["Share of global CO₂ emissions (%)"] === val_extent) {
// 				console.log(d);
// 			}
// 		});
...
// 			.attr("r", (d, i) => {
// 				// console.log(d["Share of global CO₂ emissions (%)"]);
// 				return d["Share of global CO₂ emissions (%)"] * 5;
// 			})
// 			.attr("fill", "red");
